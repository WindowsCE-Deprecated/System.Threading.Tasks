...
{
    /// <summary>
    /// Specifies flags that control optional behavior for the creation and
    /// execution of continuation tasks.
    /// </summary>
    [Flags]
    [Serializable]
    public enum TaskContinuationOptions
    {
        ...
        /// Specifies that the default behavior should be used.  Continuations,
        /// by default, will be scheduled when the antecedent task completes,
        /// regardless of the task's final <see cref="TaskStatus"/>.
        /// </summary>
        None = 0,
        ...
        /// <summary>
        /// A hint to a <see cref="TaskScheduler"/> to schedule a task in as
        /// fair a manner as possible, meaning that tasks scheduled sooner will
        /// be more likely to be run sooner, and tasks scheduled later will be
        /// more likely to be run later.
        /// </summary>
        PreferFairness = 0x01,

        /// <summary>
        /// Specifies that a task will be a long-running, course-grained
        /// operation.  It provides a hint to the <see cref="TaskScheduler"/>
        /// that oversubscription may be warranted.
        /// </summary>
        LongRunning = 0x02,
